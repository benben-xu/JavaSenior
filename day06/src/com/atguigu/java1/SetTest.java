 ...
 *  2. 要求：向Set中添加的数据，其所在的类一定要重写hashCode()和equals(0
...
public class SetTest {
    ...
    二、添加元素的过程：以HashSet为例：
        我们向HashSet中添加元素a，首先调用元素a所在类的hashCode()方法，计算元素a的的哈希值，
    ...
    //LinkedHashSet的使用
    //LinkedHashSet作为HashSet的子类，在添加数据的同时，每个数据还维护了两个引用，记录了此数据前一个数据和后一个数据。
